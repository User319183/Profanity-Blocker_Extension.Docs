...
console.log("Profanity Blocker * V1.2 * is ready.");
	...
	chrome.storage.local.get(['warningDomains'],function(result){
		for(var i = 0; i < result.warningDomains.length; i++){
			if(origin_site === result.warningDomains[i]){
				while (origin_site === result.warningDomains[i]){
					alert("WARNING: This site contains profanity and/or nudity. Please close out the current tab. If you would like to whitelist this website, please view the extension settings.");
