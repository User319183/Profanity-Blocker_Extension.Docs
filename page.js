...
chrome.runtime.onInstalled.addListener(function(details){
    var defaultSettings = {
		...
		defaultWords: [
			...
			{"count": 0,"word": "nig·ga","double":false},
		...
		substituteWords: [
			...
			{"substitute": "[mean]","word": "nig·ga","double":false},
    ...
    if(details.reason == "install"){
       chrome.storage.local.set(defaultSettings, function() {
      	alert("Profanity-Blocker has been successfully installed! Thanks for installing me! Profanity Blocker is currently on V1.2.");
    });
    }
});